...
template <typename T>
__global__ void fusedTransposeAndremovePadding(T *src,
                                               T *dst,
...
template <typename T>
void launchTransposeAndRemovePadding(TensorWrapper<T> *qkv_buf_w_pad,
    ...
    fusedTransposeAndremovePadding<T><<<grid, block>>>(qkv_buf_w_pad->data,
...
template void launchTransposeAndRemovePadding(TensorWrapper<float> *qkv_buf_w_pad,
                                              TensorWrapper<int> *padding_offset,
                                              TensorWrapper<float> *qkv_buf_wo_pad_1);

template void launchTransposeAndRemovePadding(TensorWrapper<half> *qkv_buf_w_pad,
                                              TensorWrapper<int> *padding_offset,
