...
template <typename T>
void LlamaModel<T>::initializeForContextDecoder(IntDict &int_params_first_token)
{
...
template <typename T>
void LlamaModel<T>::initializeForSelfDecoder()
{
    // nothing to do now
}
...
template <typename T>
std::vector<std::string> LlamaModel<T>::makeInput(const std::string &history, int round, const std::string &input)
{
...
std::string LlamaModel<T>::makeHistory(const std::string &history, int round, const std::string &input, const std::string &output)
{
...
template <typename T>
int LlamaModel<T>::firstTokenGen(LLaMAAttentionDynParams &dparams, IntDict &int_params_first_token)
{
...
template <typename T>
int LlamaModel<T>::continueTokenGen(LlamaAttentionDynamicParams &dparams) {
...
template <typename T>
std::string LlamaModel<T>::response(const std::vector<std::string> &input, CallBack PrintRes) {
